...
module.exports = {
  ...
  showMessageBox: function (...args) {
    ...
    let {
      buttons, cancelId, checkboxTitle, checkboxChecked, defaultId, detail,
    ...
    if (checkboxTitle == null) {
      checkboxTitle = ''
    } else if (typeof checkboxTitle !== 'string') {
      throw new TypeError('checkboxTitle must be a string')
    }
    ...
    return binding.showMessageBox(messageBoxType, buttons, defaultId, cancelId,
                                  flags, title, message, detail, checkboxTitle,
