...
module.exports = {
  showOpenDialog: function (...args) {
    var prop, properties, resolvesAliases, value, wrappedCallback
    checkAppInitialized()
    ...
    if (typeof options.resolvesAliases === 'undefined') {
      resolvesAliases = true;
    }
    return binding.showOpenDialog(options.title, options.buttonLabel, options.defaultPath, options.filters, properties, window, resolvesAliases, wrappedCallback)
  },
